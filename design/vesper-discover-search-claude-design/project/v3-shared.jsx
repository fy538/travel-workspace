  ...
  return (
    <div style={{ padding: '14px 22px 0' }}>
      ...
      <div style={{ marginTop: 18 }}>
        ...
        {meta && (
          <div style={{ fontSize: 11.5, color: T.mute, marginTop: 8, fontFamily: T.serif, fontStyle: 'italic' }}>
            {meta}
          </div>
        )}
      </div>
  ...
  return (
    <div style={{ padding: '0 22px' }}>
      ...
      <div style={{
        ...
        {/* baseline */}
        <div style={{
          position: 'absolute', left: 4, right: 4, top: 10, height: 1,
        ...
        {months.map((m, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              {!d && (
                <div style={{ width: 3, height: 3, borderRadius: 999, background: T.muteSoft, opacity: 0.55 }}/>
              )}
              <div style={{
                fontSize: 8.5, color: i === now ? T.ink : T.muteSoft,
      ...
      {(title || sub || date) && (
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginTop: 8 }}>
          <div>
            ...
            {sub && (
              <div style={{ fontSize: 10.5, color: T.mute, marginTop: 3, fontStyle: 'italic', fontFamily: T.serif }}>
                {sub}
              </div>
            )}
          </div>

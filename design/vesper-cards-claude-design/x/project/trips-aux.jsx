  ...
  return (
    <Phone bg={T.bg}>
      ...
      <div style={{ padding: '10px 22px 0' }}>
        <h1 style={{
          fontFamily: T.serif, fontWeight: 500, fontSize: 30, lineHeight: 0.98,
          letterSpacing: -0.8, color: T.ink, margin: 0,
        }}>
          What changed, <span style={{ fontStyle: 'italic' }}>since you looked.</span>
        </h1>
        <div style={{ marginTop: 4, fontSize: 11.5, color: T.mute, fontStyle: 'italic', fontFamily: T.serif }}>
    ...
    <div style={{ padding: '10px 22px 0' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
          ...
          <span style={{ fontSize: 9.5, color: T.mute, letterSpacing: 1.8, fontWeight: 700 }}>
            {label}
          </span>
        </div>
...
function NotifRow({ dot, when, title, sub, actionLabel, source, golden }) {
  return (
    <div style={{
      padding: '9px 12px', background: golden ? 'rgba(176,133,58,0.06)' : T.cardWarm,
      borderRadius: 11,
      border: golden ? `0.8px solid rgba(176,133,58,0.4)` : `0.5px solid ${T.hairline}`,
      display: 'grid', gridTemplateColumns: '12px 1fr auto', gap: 10, alignItems: 'flex-start',
    }}>
      ...
      <div style={{ minWidth: 0 }}>
        <div style={{
          fontFamily: T.serif, fontSize: 13.5, color: T.ink, fontWeight: 500,
        ...
        <div style={{
          ...
          fontSize: 9, color: T.muteSoft, letterSpacing: 1.2, fontWeight: 600,
        }}>
      ...
      <div style={{
        fontSize: 9, color: golden ? T.goldDeep : T.inkSoft, letterSpacing: 1.4, fontWeight: 700,
        padding: '4px 7px', border: `0.6px solid ${golden ? T.gold : T.hairline}`,

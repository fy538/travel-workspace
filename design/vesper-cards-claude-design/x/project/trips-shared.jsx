  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{
          width: 30, height: 30, borderRadius: 999, border: `0.5px solid ${T.hairline}`,
          background: T.cardWarm, position: 'relative',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
        }}>
          <TripIcons.Bell s={14} c={T.inkSoft}/>
          <span style={{
            position: 'absolute', top: 3, right: 3, width: 6, height: 6, borderRadius: 6,
            background: TR.needsYou, border: `1.5px solid ${T.cardWarm}`, boxSizing: 'content-box',
          }}/>
        </div>
      </div>
    </div>
...
function StarterChip({ name, sub, glyph, accent }) {
  return (
    <div style={{
      ...
      <div style={{
        fontFamily: T.serif, fontStyle: 'italic', fontSize: 11, color: T.mute,

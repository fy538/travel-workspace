...
Source: `docs/journeys/journeys.yaml` × derived coverage (FE mock-walk / BE pytest file presence) × live persona-cert. Regenerate: `make dogfood-status-sync`. Set integrity: `make journey-registry-check`. Legend: ✅ present/pass · ⤵️ skip · 🔴 fail · — none.

...
| E1/E8 | The addressed place-note doorway now captures the mounted entity/account/path lifetime before opening or submitting; a route, account, or entity transition suppresses the delayed composer and prevents stale handoff delivery or success UI while leaving the backend owner/revocation contract unchanged. | `travel-app:85eba258f` |
...
- The addressed-handoff component suite and the focused entity mutation/page
  group pass (**42 tests** in this run), including the lifetime guard for a

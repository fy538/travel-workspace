...
def board():
    ...
    r3 = [viewport(col(mistaken(), caption('03.7 · WHAT VESPER HAD UNDERSTOOD', 'A LIMITATION READ ONTO THE PERSON', 'Before the correction: one March afternoon with a father has become &ldquo;stairs are kept off your afternoons&rdquo;. The page says what it believes and where it got it, and offers the one door that matters'))),
          ...
          notecol('One correction, from the mistake to the visit after it', [
              ...
              ('THE USEFUL DIFFERENCE, AND THE REMAINING CHANCE', N('Today looks almost the same, and that is the honest outcome: the father is here, so the level afternoon is right either way. The difference is what the mistaken reading had removed from the page altogether. Rooms Remade ends Sunday and today&rsquo;s level treatment belongs to today, because he is here; the false generalisation does not come back with it tomorrow. That leaves exactly one feasible way to the rooms: Sunday, alone, the last day. The phone names that; it does not arrange it.')),
              ('CAUSAL REPAIR · CONTRIBUTION AND CONSEQUENCE §8', N('The mistake was a relation, not a card: &ldquo;this person avoids stairs&rdquo;, inferred from an afternoon planned with a father. The correction invalidates that relation at the owner that holds it and repairs its dependent uses: the rooms hidden on this page, the &ldquo;kept off your afternoons&rdquo; register line, and any other surface it had filtered. It keeps the independently true context, his constraint on outings he joins. Today&rsquo;s level afternoon is a current-day treatment that expires on its own; the repair does not. <b>Next-day evidence:</b> 03.9, alone, shows the stairs as a fact of the building, the rooms upstairs offered, and no line keeping anything off the person&rsquo;s afternoons.')),
              ('WHAT IS NOT CLAIMED', N('03.9 does not say the March visit happened. An afternoon was planned; nothing in this design observes an arrival, so the record says what it knows and no more. The correction does not trade the false generalisation for an invented one: no standing preference for stairs, profile or mode is created. The father&rsquo;s own constraint is kept, attached to the outings he is on.')),
              ('OPEN', N('Whether &ldquo;that is not right&rdquo; should be a door on the page, as drawn, or a reply in the question line. Whether the repair should be visible on the March afternoon&rsquo;s own record as well as taking effect everywhere it was used. Interaction untested.'))], w=760)]

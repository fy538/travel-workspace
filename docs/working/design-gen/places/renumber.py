...
boards = blk('BOARDS', tbl(['BOARD', 'WHAT IT IS', 'WAS'], [['01 - The Field', 'The chosen scroll, populated and cold, with the notes on each section&rsquo;s instrument', '19'], ['02 - The Journeys', 'Exploration; human receiving in three independent branches; practical continuation', '21'], ['03 - The Situations', 'Another city before arrival; sparse supply; the map unavailable; results pending', '22'], ['04 - The Checks and the Opening', 'Long names; text at 1.3&times;; the opening&rsquo;s door, what it opens, and the return', '20'], ['05 - Decisions', 'Five sentences, proposed, not accepted', '08'], ['06 - Log', 'One row per pass since the first export', '09'], ['07 - Components', 'Every piece of the kit at phone width, then the field, focus, path, live and social kinds taken from the canon and The Page, marked drawn, adapted or new; what was left out and why; tokens', 'new'], ['08 - The Page', 'The Harbor Print Room opened from the field, populated, cold and after a change, drawn with the focus, path, live and social kinds under the object-page rulings', 'new'], ['Archive', 'Every earlier board (01, 02 to 07, 10 to 18, the §12 polish of 19 and 20) as pushed HTML, in the repository under docs/working/design-gen/places/archive, with the generators that draw the current boards', 'Z01 to Z20']]))

...
now = blk('WHERE THINGS STAND', N('<b>Home brings forward what matters in my life. Places lets me explore what the world could offer.</b> The composition is the synthesis of September 7 (a mixed-value field with one pocket) and its expression is the one the founder chose that night: Home&rsquo;s kit for the chrome, the rows and the people, and the canon&rsquo;s kinds and instruments wherever a section has data to show. A photo slot is a hatched plate, never a drawing. 01 is the field, populated and cold; 02 the three journeys; 03 the four situations; 04 the checks and the opening sequence; 05 and 06 the decisions and the log; 07 the components sheet; 08 the place page. Everything on every phone is a fixture; every transition is an ordered static frame; nothing inside a phone explains the architecture. Every board has a NOTES control at its top right that hides all commentary.'))
boards = blk('BOARDS', tbl(['BOARD', 'WHAT IT IS', 'WAS'], [['01 - The Field', 'The chosen scroll, populated and cold, with the notes on each section&rsquo;s instrument', '19'], ['02 - The Journeys', 'Exploration; human receiving in three independent branches; practical continuation', '21'], ['03 - The Situations', 'Another city before arrival; sparse supply; the map unavailable; results pending', '22'], ['04 - The Checks and the Opening', 'Long names; text at 1.3&times;; the opening&rsquo;s door, what it opens, and the return', '20'], ['05 - Decisions', 'Five sentences, proposed, not accepted', '08'], ['06 - Log', 'One row per pass since the first export', '09'], ['07 - Components', 'Every piece of the kit at phone width: chrome, rows, human units, cards and kinds, instruments, tokens; each with its origin and when it is used', 'new'], ['08 - The Page', 'The Harbor Print Room opened from the field, in six states, with the focus, path, live and social kinds', 'new'], ['09 - Stages', 'The same Friday for one person at four points of use: first open, first week, settled, a year in; the deltas section by section', 'new'], ['Archive', 'Every earlier board (01, 02 to 07, 10 to 18, the §12 polish of 19 and 20) as pushed HTML, in the repository under docs/working/design-gen/places/archive, with the generators that draw the current boards', 'Z01 to Z20']]))
...
inner = headblock('00 &middot; INDEX &middot; 09-08', 'Vesper &mdash; Places', 'One complete Places experience, iterated through seven critiques on September 7 and cleaned up on September 8. Start with 01, then 09, 02 and 08.') + '<div style="display: flex; flex-direction: column; gap: 34px;">' + minis + now + boards + outside + '</div>'

...
The latest backend slice also preserves source-owned permanent-closure copy
in Home's already-admitted private Place doorway, only when the closure notice
and canonical venue identities match. It does not carry the Places `CLEAR`
action; reopened/weather `NOTICE` cards remain excluded. This corrects one
existing receiving path, not Home's broader content composition or coverage.
...
**Functional-code tuple at this rebaseline:** workspace `82d4304`, backend
`95b0361ab`, and app `a4de82802`, all clean on the isolated
...
product people are meant to use. The saved-place closure trace confirms that
owner-backed material was already admitted to Home but needed its exact status
copy preserved; reopened/weather notices remain a separate admission decision.
Home already has a native, owner-backed
...
**Current inspected checkout tuple:** workspace `82d4304`, backend
`95b0361ab`, and app `a4de82802` (workspace hash is the parent before this

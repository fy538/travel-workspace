...
wave):** for all package decisions below, use workspace `2319671`, backend
`0962f95a6`, and app `2eefb9c1d`. The backend root-projection packet remains
**481 tests**; the full offline backend gate now passes **21,661 tests** with
...
tuple is workspace `2319671`, backend `0962f95a6`, and app `2eefb9c1d` on the
...
481-root / 21,661-full-backend and 566-app test packets are supporting evidence,
not the exit itself.

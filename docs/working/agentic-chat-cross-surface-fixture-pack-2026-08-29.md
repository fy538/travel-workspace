...
expires: 2026-09-28
why_new: Converts the accepted Chat-as-agentic-interface direction into eighteen comparable cross-surface turn contracts that can generate context, capability, authority, artifact, owner, and return requirements.
promotes_to: null
supersedes: []
related:
...
This pack makes eighteen turns comparable. The original twelve detailed
contracts remain the core cross-surface set; A13–A18 extend the machine
portfolio with quiet Home value, everyday contribution, asynchronous social
value, post-return re-entry, Life re-finding, and longitudinal compounding.
Their exact offline frames live in
`travel-agent/tests/concierge/fixtures/agentic_turn_portfolio.json` and are
covered by the compiler and selector assertions. This is a product and
architecture probe, not a visual specification and not authorization to
implement a generic agent framework.
...
| A13 | quiet Home | explore | Opening projection / Place / Relationship | Can a quiet Home view provide complete value without demanding input? |
| A14 | everyday contribution | understand | Source / Place / Commitment | Can an authored source produce immediate value with bounded private residue? |
| A15 | asynchronous social contribution | coordinate | Place / Occasion / Relationship | Can social evidence add possibility without becoming a feed or widening authority? |
| A16 | post-return Home | explore | Place / Opening projection / Relationship | Can the return home project forward while carrying useful travel context? |
| A17 | Life re-finding | explore | Life / Place / Relationship | Can durable Life retrieval reopen useful context without archive homework? |
| A18 | longitudinal compounding | compare | Life / Place / Relationship | Can prior evidence improve a later comparison while preserving causal and authority boundaries? |
...
| A13 | yes | optional owner deepening | inferred preference from ignored Home units | complete-on-view Home composition or silence |
| A14 | no for a clearly authored Bring | private Source/Claim residue and bounded association | occurrence, global preference, or audience widening | Source/owner readback |
| A15 | yes until explicit audience/action grant | Occasion proposal or shared projection | private evidence or participant identity | audience-safe social projection |
| A16 | yes | forward-looking opening or Places continuation | retrospective-only feed or forced nostalgia | Home composition / optional return |
| A17 | yes | saved re-finding composition | archive taxonomy or durable preference from a read | Life result with causal source lineage |
| A18 | yes | only the consequence independently authorized now | inherited authority, stale evidence, or forced opening | causal lineage or earned silence |

## 17. Capability coverage generated by the fixtures

The eighteen cases require the following stable capability families. They do not
require itinerary-shaped model tools or one tool per visual component.

| Capability family | Fixtures |
| --- | --- |
| Source, claim, and artifact inspection/repair | A02, A05, A11, A12, A14, A18 |
| Life and cross-episode retrieval/comparison | A05, A12, A17, A18 |
| Place search, read, comparison, and routing | A01, A03, A04, A06, A07, A12-A18 |
| Plan, Occasion, and Commitment shape/operations | A01, A03, A04, A06-A10 |
| Relationship/audience-safe coordination | A01, A03, A06-A09, A13-A18 |
| Provider preparation, execution, and reconciliation | A02, A06, A08-A10 |
| Monitor and material-change delivery | A09, A10 |
| Opening explanation, transition, and return policy | A03, A09, A11-A18 |
...
The pack is ready to promote only when all eighteen fixtures can answer, with no
hand-waving:

...
**Date:** 2026-07-08 · **Repo touched:** `travel-agent` only (all six items landed backend-side; the one FE piece is flagged below). **Grounded in:** the archived [content-contracts audit](archive/2026-07/consolidated/content-contracts-audit.md) + [content-contracts-open-questions.md](content-contracts-open-questions.md).

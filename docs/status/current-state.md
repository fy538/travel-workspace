...
|---|---:|---|
| API contract | 392 paths / 436 operations / 828 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 265 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 409 paths / 453 operations / 878 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 278 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 381 paths / 423 operations / 803 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 247 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 432 paths / 480 operations / 965 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 297 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

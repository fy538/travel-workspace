...
|---|---:|---|
| API contract | 330 paths / 368 operations / 638 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 186 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 377 paths / 419 operations / 793 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 231 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

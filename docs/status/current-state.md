...
|---|---:|---|
| API contract | 467 paths / 520 operations / 1059 schemas | [`docs/openapi.json`](../openapi.json) |
| Canonical journeys | 28 total / 12 golden path / 7 holistic extension | [`journeys.yaml`](../journeys/journeys.yaml) |
| Feature flags | 74 registered / 73 active / 1 resolved | [`registry.yaml`](../flags/registry.yaml) |
| System charters | 20 Markdown documents | [`systems/`](../systems/) |
| Documentation inventory | 336 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

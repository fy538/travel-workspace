...
|---|---:|---|
| API contract | 411 paths / 455 operations / 894 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 281 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 581 paths / 643 operations / 1482 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 602 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

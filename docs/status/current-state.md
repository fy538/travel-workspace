...
|---|---:|---|
| API contract | 467 paths / 520 operations / 1039 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 324 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

...
|---|---:|---|
| API contract | 385 paths / 428 operations / 814 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 253 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

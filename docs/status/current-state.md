...
|---|---:|---|
| API contract | 551 paths / 613 operations / 1275 schemas | [`docs/openapi.json`](../openapi.json) |
...
| Documentation inventory | 382 files classified | [`inventory.yaml`](../governance/inventory.yaml) |

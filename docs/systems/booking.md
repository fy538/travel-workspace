...
- **Cancellation recovery survives restart** — public booking reads expose only bounded cancellation state (`pending`, `cancelled`, or `manual_action_required`); provider reconciliation evidence remains private.
